...
contract SwapSwap is Ownable {
    ...
    function swapNormal() external onlyWhitelist {
        ...
        require(_swapNormal.wethLimit > 0, "weth limit exceedee");
        uint256 wethToSend;
        bool _isV3Router = IsV3Router(path);
    ...
    function getPath(address token, uint24 poolFee)
        internal
        view
        returns (
            address[] memory path,
    ...
    function multiBuyNormal() external onlyWhitelist {
        ...
        require(_multiBuyNormal.wethLimit > 0, "weth limit exceedee");
