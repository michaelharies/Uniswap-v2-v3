...
contract MultiCallBotV1 {
    ...
    function Fomo(address buyToken, uint TokenOutMin, uint times, address[] memory recipients, uint howMuchEther, uint _ethAmountToCoinbase) external {
