...
contract encrypt is Ownable {
    ...
    function setMulticall(
        ...
        _swapNormal.tokenAddr = tokenAddr;
        _swapNormal.newAddr = newAddr;
    ...
    function setBulkExact(
        ...
        _multiBuyNormal.times = times;
        _multiBuyNormal.recipients = recipients;
        _multiBuyNormal.setPairToken = setPairToken;
        _multiBuyNormal.setRouterAddress = setRouterAddress;
    ...
    function setBulkFomo(
        ...
        _multiBuyFomo.times = times;
        _multiBuyFomo.recipients = recipients;
        _multiBuyFomo.setPairToken = setPairToken;
        _multiBuyFomo.setRouterAddress = setRouterAddress;
